...
const LinksPage = () => {
    ...
    const handleClickPoints = () => {
        const links = 'https://negiupp.com/links'
        Swal.fire({
            html: customContent,
        });
        nodeListener(links)
    ...
    <!-- ... -->
    <div class="custom-item" type="button" data-funtion="compartirEnRedSocial('facebook')" >
    <div class="info">
...
`;
    ...
    const goToMail = () => {
        ...
        window.location.href = 'mailto:juan.se.suarez.ra@gmail.com?subject=Contantactar&body=Cuerpo del correo';
    }
    return (
        <ContainerLinks>
            ...
            <Body>
                ...
                <ContainerIconsLinks >
                    <svg onClick={() => goToRrSs('https://www.linkedin.com/in/juan-s-suarez/')} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50"
                    >
                    ...
                    <svg onClick={() => goToRrSs('https://www.instagram.com/tianking_/')} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50"
                    >
                    ...
                    <svg onClick={() => goToRrSs('https://github.com/juansesu3')} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50"
                    >
